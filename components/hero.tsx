...
export default function Hero() {
  return (
    <section className="relative h-[80vh] w-full overflow-hidden pt-[96px]" id="inicio"> {/* Añadido id="inicio" */}
      ...
      <Image
        src="/images/foto44.jpeg" // <--- ¡CAMBIA ESTO por la ruta real de tu nueva imagen!
        alt="VAGMETAL: Fabricación y montaje de estructuras metálicas industriales en Chile" // Alt text mejorado
        fill
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center text-white sm:px-6 lg:px-8">
        ...
        <h1 className="mb-6 max-w-4xl text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
          VAGMETAL SPA: Especialistas en Estructuras Metálicas a Medida
        </h1>
        ...
        <p className="mb-8 max-w-2xl text-lg text-gray-200 sm:text-xl">
          Diseñamos, fabricamos y montamos soluciones robustas para galpones, naves industriales y todo tipo de proyectos estructurales en Santiago, Chile.
        </p>
