                  ...
                  <div className="relative aspect-w-1 aspect-h-1 group">
                    ...
                    {project.images.length > 1 && (
                      <>
                        ...
                        >
                          <ChevronLeft className="h-7 w-7" /> {/* Tamaño un poco más grande para visibilidad */}
                        </button>
                        <button
                        ...
                        >
                          <ChevronRight className="h-7 w-7" /> {/* Tamaño un poco más grande para visibilidad */}
                        </button>
                      </>
                    )}
                  </div>
          ...
          <TabsContent value="galeria" className="mt-6">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {galleryImagesData.map((img, index) => (
                <div key={index} className="group relative overflow-hidden rounded-lg aspect-w-3 aspect-h-4"> {/* CAMBIO 3: Relación 3:4 para más alto que ancho */}
                  <Image
                    src={img.src}
                    alt={img.alt}
                    fill
                  ...
                  />
                  {/* CAMBIO 4: Overlay de fondo sólido para asegurar contraste del texto blanco (mantiene lo que te funcionó) */}
